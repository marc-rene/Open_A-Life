...
#define INFOc(...)                                                                                        \
    {                                                                                                     \
        try                                                                                               \
        {                                                                                                 \
            A_LIFE::A_LIFE_Log::GetLogger()->trace(__VA_ARGS__);                                          \
        }                                                                                                 \
...
#define INFO(logger_name, ...)                                                                           \
    {                                                                                                    \
        try                                                                                              \
        {                                                                                                \
            A_LIFE::A_LIFE_Log::GetLogger(logger_name)->trace(__VA_ARGS__);                              \
        }                                                                                                \
        catch (const std::exception &e)                                                                  \
        {                                                                                                \
            std::cout << std::format("\n!Trace log error: {}!\n", e.what()) << std::format(__VA_ARGS__); \
...
#define SUCCESSc(...)                                                                                       \
    {                                                                                                       \
        try                                                                                                 \
        {                                                                                                   \
            A_LIFE::A_LIFE_Log::GetLogger()->info(__VA_ARGS__);                                             \
        }                                                                                                   \
        catch (const std::exception &e)                                                                     \
        {                                                                                                   \
            std::cout << std::format("\n!!!INFO LOG ERROR: {}!!!\n", e.what()) << std::format(__VA_ARGS__); \
...
#define SUCCESS(logger_name, ...)                                                                           \
    {                                                                                                       \
        try                                                                                                 \
        {                                                                                                   \
            A_LIFE::A_LIFE_Log::GetLogger(logger_name)->info(__VA_ARGS__);                                  \
        }                                                                                                   \
        catch (const std::exception &e)                                                                     \
        {                                                                                                   \
            std::cout << std::format("\n!!!INFO LOG ERROR: {}!!!\n", e.what()) << std::format(__VA_ARGS__); \
...
#define ERRORc(...)                                                                                          \
    {                                                                                                        \
        try                                                                                                  \
        {                                                                                                    \
            A_LIFE::A_LIFE_Log::GetLogger("A-HUGE-ERROR")->critical(__VA_ARGS__);                            \
        }                                                                                                    \
        catch (const std::exception &e)                                                                      \
        {                                                                                                    \
            std::cout << std::format("\n!!!FUCK FUCK ERROR: {}!!!\n", e.what()) << std::format(__VA_ARGS__); \
