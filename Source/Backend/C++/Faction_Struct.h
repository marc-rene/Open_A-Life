...
struct FACTION
{
	...
	std::string						Callsign;
    uShort                             Selected_Force_Location;
    uShort                             Fac_Home_Location;  
	...
	FACTION(uMint id,	std::string name, 	std::string callsign,	uShortstarting_strength,	uShortstarting_tile,	std::thread* thread_to_use,	Faction_Structure military_structure,	 uMint logging_level)
	{
		Fac_ID 						= 	id;
		Fac_Name 					= 	name;
		Callsign 					= 	callsign;
    ...
    void    Move   (   Direction  Where_to_captain    )            
    {
        ...
        */
        ...
        HIGH_LOG(Fac_Name << " completed move function");
    }
    ///////////////////////////////////////////////////////////
	...
	void TAKE_A_BREAK(uShortmiliseconds)
	{
		NAP(miliseconds*SPEED_DIVIDER);
	}
};
